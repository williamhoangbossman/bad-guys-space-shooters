...
func setUp(data: enemyStats, config: DifficultyData) -> void: 
	currentHealth = int(data.maxHealthPoints * config.enemyMaxHPMultiplier)
	stats.moveSpeed = data.moveSpeed * config.enemyMoveSpeedMultiplier
