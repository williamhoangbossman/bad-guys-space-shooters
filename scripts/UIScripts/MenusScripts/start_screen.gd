...
var default_cursor = preload("res://assets/UI/Player/cursor.png")
var glove_cursor = preload("res://assets/UI/Player/glove.png")
...
func _ready() -> void:
	...
	Input.set_custom_mouse_cursor(glove_cursor, Input.CURSOR_POINTING_HAND, Vector2(0, 0))
